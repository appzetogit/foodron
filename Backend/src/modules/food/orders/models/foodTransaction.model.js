...
const foodTransactionSchema = new mongoose.Schema({
    ...
    amounts: {
        ...
        /** Menu-discount breakdown (already included in adminDiscountShare / restaurantDiscountShare). */
        menuDiscount: { type: Number, default: 0, min: 0 },
        menuAdminDiscountShare: { type: Number, default: 0, min: 0 },
        menuRestaurantDiscountShare: { type: Number, default: 0, min: 0 },
        couponDiscount: { type: Number, default: 0, min: 0 },
        quickDeliveryFee: { type: Number, default: 0, min: 0 },
        quickPlatformShare: { type: Number, default: 0, min: 0 },
        quickRiderBonus: { type: Number, default: 0, min: 0 },
