                ...
                {filteredRestaurants.length === 0 ? (
                  ...
                  filteredRestaurants.map((restaurant) => (
                    <tr key={restaurant.sl} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm font-medium text-slate-900">{restaurant.totalItemAmount}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-green-600 font-medium">{restaurant.restaurantEarning}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
