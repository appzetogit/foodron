            ...
            <div className="px-6 pb-6 space-y-4">
              ...
              {selectedAd.description && (
                <div className="mt-4">
                  ...
                  <p className="text-sm text-slate-900 bg-slate-50 p-3 rounded-lg border border-slate-100">{selectedAd.description}</p>
                </div>
              )}

              {selectedAd.fileDescription && (
                <div className="mt-4">
                  <p className="text-sm font-semibold text-slate-700 mb-1">Image Description</p>
                  <p className="text-sm text-slate-900 bg-slate-50 p-3 rounded-lg border border-slate-100">{selectedAd.fileDescription}</p>
                </div>
              )}
