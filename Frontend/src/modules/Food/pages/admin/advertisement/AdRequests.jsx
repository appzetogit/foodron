                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="w-48 bg-white border border-slate-200 rounded-lg shadow-lg z-50">
                            ...
                            {(request.status === "new" || request.status === "update" || !request.status) && (
                              <>
                                <DropdownMenuSeparator />
                                <DropdownMenuItem 
            ...
            <div className="px-6 pb-6 space-y-4">
              ...
              {selectedRequest.description && (
                <div className="mt-4">
                  ...
                  <p className="text-sm text-slate-900 bg-slate-50 p-3 rounded-lg border border-slate-100">{selectedRequest.description}</p>
                </div>
              )}

              {selectedRequest.fileDescription && (
                <div className="mt-4">
                  <p className="text-sm font-semibold text-slate-700 mb-1">Image Description</p>
                  <p className="text-sm text-slate-900 bg-slate-50 p-3 rounded-lg border border-slate-100">{selectedRequest.fileDescription}</p>
                </div>
              )}
